 ...
 *
 * @file SpotMessageSoftwareInfo.cpp
...
SpotMessageSoftwareInfo::SpotMessageSoftwareInfo (void)
:  AbsSpotMessageWithAppCatCmdID (false, CMessageRequestPinpadAppId, CSoftwareInfoCommandId, CSoftwareInfoSubCommandId)
{
...
bool SpotMessageSoftwareInfo::setItems(unsigned int uQty, const unsigned char* pbItemCodes)
{
...
ISpotMessage::BufferType SpotMessageSoftwareInfo::serialize (void) const
{
  ...
  std::cout << "SpotMessageSoftwareInfo::serialize() - Length: " << size() << " bytes.\n";
...
bool SpotMessageSoftwareInfo::parse (BufferType const & buff)
{
  ...
  std::cout << "SpotMessageSoftwareInfo::parse() - Length: " << size() << " bytes.\n";
  char* pcBuffer = new char[3 * size() + 2];
