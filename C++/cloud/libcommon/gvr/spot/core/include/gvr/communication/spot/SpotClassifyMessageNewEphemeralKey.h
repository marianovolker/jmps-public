 ...
 *
 * @file SpotClassifyMessageNewEphemeralKey.h
 * @author mgrieco
 * @date Tuesday, March 31, 2015
 * @copyright Copyright © 2014, 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _SPOTCLASSIFYMESSAGENEWEPHEMERALKEY_H_
# define _SPOTCLASSIFYMESSAGENEWEPHEMERALKEY_H_
...
# include <gvr/communication/spot/SpotMessageNewEphemeralKey.h>
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      namespace spot
      {
        class SpotClassifyMessageNewEphemeralKey : public ISpotClassifyMessage
        {
        public:
           ...
           */
          ~SpotClassifyMessageNewEphemeralKey (void);
        };
      }
    }
  }
