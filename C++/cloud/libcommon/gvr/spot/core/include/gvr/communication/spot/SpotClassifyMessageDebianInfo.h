 ...
 *
 * @file SpotClassifyMessageDebianInfo.h
 * @author mgrieco
 * @date Wednesday, February 18, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _SPOTCLASSIFYMESSAGEDEBIANINFO_H_
# define _SPOTCLASSIFYMESSAGEDEBIANINFO_H_
...
# include <gvr/communication/spot/SpotMessageDebianInfo.h>
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      namespace spot
      {
        class SpotClassifyMessageDebianInfo : public AbsSpotClassifyMessageHeader
        {
        public:
           ...
           */
          ~SpotClassifyMessageDebianInfo (void);
        };
      }
    }
  }
