 ...
 *
 * @file UccMessageFileDownload.h
 * @author pcantarini
 * @date Monday, Mars 02, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _UCCMESSAGEFILEDOWNLOAD_H_
# define _UCCMESSAGEFILEDOWNLOAD_H_
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      namespace ucc
      {
         ...
         * @author pcantarini
         */
        class UccMessageFileDownload : public AbsUccMessageInternal
        {
        public:
          ...
          * @since 0.0.0
          * */
          virtual ~UccMessageFileDownload (void);
