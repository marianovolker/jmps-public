 ...
 *
 * @file AbsUccMessageCloudCommandResponse.h
 * @author pcantarini
 * @date Monday, Mars 02, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _ABSUCCMESSAGECLOUDCOMMANDRESPONSE_H_
# define _ABSUCCMESSAGECLOUDCOMMANDRESPONSE_H_
...
#include <gvr/communication/ucc/message/base/AbsUccMessageCloud.h>
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      {
        /**
         * @brief This class is the base class for all cloud command response ucc messages.
         * @see gvr.communication.ucc.IUccMessage
         * @since 0.0.0, 2015-03-02
         * @version 0.0.0, 2015-03-02
         * @author pcantarini
         */
        class AbsUccMessageCloudCommandResponse : public AbsUccMessageCloud
        {
        public:
          static char const * CSuccessName; /** @brief Ucc Cloud Command Response Success field name. */

          /**
          * @brief Destructor
          * @since 0.0.0
          * */
          virtual ~AbsUccMessageCloudCommandResponse (void) = 0;
        ...
        protected:
           ...
           */
          AbsUccMessageCloudCommandResponse (void);
        };
      }
    }
  }
