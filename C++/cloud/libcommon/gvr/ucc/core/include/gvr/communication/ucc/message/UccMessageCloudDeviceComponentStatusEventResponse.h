 ...
 *
 * @file UccMessageCloudDeviceComponentStatusEventResponse.h
 * @author mgrieco
 * @date Monday, Jun 29, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _UCCMESSAGECLOUDDEVICECOMPONENTSTATUSEVENTRESPONSE_H_
# define _UCCMESSAGECLOUDDEVICECOMPONENTSTATUSEVENTRESPONSE_H_
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      namespace ucc
      {
         ...
         */
        class UccMessageCloudDeviceComponentStatusEventResponse : public AbsUccMessageCloudEventResponse
        {
        public:
          ...
          * @since 0.0.0
          * */
          virtual ~UccMessageCloudDeviceComponentStatusEventResponse (void);
           ...
           */
          UccMessageCloudDeviceComponentStatusEventResponse (void);
