 ...
 *
 * @file UccMessageCloudDeviceComponentStatusEvent.h
 * @author mgrieco
 * @date Monday, Jun 29, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _UCCMESSAGECLOUDDEVICECOMPONENTSTATUSEVENT_H_
# define _UCCMESSAGECLOUDDEVICECOMPONENTSTATUSEVENT_H_
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      namespace ucc
      {
         ...
         */
        class UccMessageCloudDeviceComponentStatusEvent : public AbsUccMessageCloudEventRequest
        {
        public:
          ...
          {
            eIdle=0,eInUse, eDown, eInWarning, eInError, eEnabled, eDisabled, eStartup, eDownload, eTotalStatuses
          };
           ...
           */
          /**@brief Component message field name*/
          ...
          * @since 0.0.0
          * */
          virtual ~UccMessageCloudDeviceComponentStatusEvent (void);

          /**
           * @brief Constructor.
           * */
          UccMessageCloudDeviceComponentStatusEvent (void);
