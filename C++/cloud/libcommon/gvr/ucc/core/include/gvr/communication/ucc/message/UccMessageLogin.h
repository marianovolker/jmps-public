 ...
 *
 * @file UccMessageLogin.h
 * @author pcantarini
 * @date Monday, Mars 02, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _UCCMESSAGELOGIN_H_
# define _UCCMESSAGELOGIN_H_
...
#include <gvr/communication/ucc/message/base/AbsUccMessageInternal.h>
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      {
        /**
         * @brief This class is the client ucc internal message login.
         * @see gvr.communication.ucc.IUccMessage
         * @since 0.0.0, 2015-03-02
         * @version 0.0.0, 2015-03-02
         * @author pcantarini
         */
        class UccMessageLogin : public AbsUccMessageInternal
        {
        public:
