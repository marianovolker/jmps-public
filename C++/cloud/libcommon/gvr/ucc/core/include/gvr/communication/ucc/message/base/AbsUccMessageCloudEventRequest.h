 ...
 *
 * @file AbsUccMessageCloudEventRequest.h
 * @author pcantarini
 * @date Monday, Mars 02, 2015
 * @copyright Copyright © 2015 Gilbarco Inc. Confidential and Proprietary.
 */

#ifndef _ABSUCCMESSAGECLOUDEVENTREQUEST_H_
# define _ABSUCCMESSAGECLOUDEVENTREQUEST_H_
...
#include <gvr/communication/ucc/message/base/AbsUccMessageCloud.h>
  ...
  namespace gvr
  {
    ...
    namespace communication
    {
      ...
      {
        /**
         * @brief This class is the base class for all cloud event request ucc messages.
         * @see gvr.communication.ucc.IUccMessage
         * @since 0.0.0, 2015-03-02
         * @version 0.0.0, 2015-03-02
         * @author pcantarini
         */
        class AbsUccMessageCloudEventRequest : public AbsUccMessageCloud
        {
        public:
          static char const * COperationName; /** @brief Ucc Cloud Event Request Operation field name. */
          static char const * CDeviceIdName;  /** @brief Ucc Cloud Event Request Device Id field name. */
          static char const * CPayloadName;   /** @brief Ucc Cloud Event Request Payload field name. */

          /**
          * @brief Destructor
          * @since 0.0.0
          * */
          virtual ~AbsUccMessageCloudEventRequest (void) = 0;
        ...
        protected:
           ...
           */
          AbsUccMessageCloudEventRequest (char const *);
