...
"""
.. module:: GVRlib.Pinpad.Enum2
   :platform: Unix, Windows 
   :synopsis: Definitions of enumeration types (Python 2).
...
if thirdparty is None:
	...
	enumeration = importlib.import_module('3rdparty.flufl.enum')
	globals()['Enum'] = getattr(enumeration, 'Enum')
