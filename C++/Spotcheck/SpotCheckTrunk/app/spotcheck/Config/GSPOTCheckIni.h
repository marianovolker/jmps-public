...
class GSPOTCheckIni
{
	public:
		   ...
		   inline static GSPOTCheckIni* GetSoleInstance();
		             ...
		             inline const UINT8 GetSecureAudioScreenResID();
		                           bool Initialize();
		                           bool ReadSecureAudioSCRId();
		             inline const   int GetRunningMode();
		             inline const   int GetRomfsNumber();
...
inline const UINT8 GSPOTCheckIni::GetSecureAudioScreenResID()
{
	return m_u8SecureAudioResId;
}

inline const int GSPOTCheckIni::GetRunningMode()
{
	return m_iRunningMode;
}

inline const int GSPOTCheckIni::GetRomfsNumber()
{
	return m_iRomfsNumber;
}
