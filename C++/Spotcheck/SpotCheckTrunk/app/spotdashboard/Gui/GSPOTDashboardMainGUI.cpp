...
GSPOTDashboardMainGUI::GSPOTDashboardMainGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText1111 = new wxStaticText( m_panelCategories, wxID_ANY, wxT("Other Errors OK?"), wxDefaultPosition, wxSize( -1,18 ), 0 );
	m_staticText1111->Wrap( -1 );
	m_staticText1111->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	
	fgSizer72->Add( m_staticText1111, 0, wxALL, 5 );
	...
	m_staticTextOtherErrorsDISPLAY = new wxStaticText( m_panelDisplay, wxID_ANY, wxT("YES"), wxDefaultPosition, wxSize( 230,20 ), 0|wxSIMPLE_BORDER );
	m_staticTextOtherErrorsDISPLAY->Wrap( -1 );
	m_staticTextOtherErrorsDISPLAY->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	m_staticTextOtherErrorsDISPLAY->SetForegroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOW ) );
	m_staticTextOtherErrorsDISPLAY->SetBackgroundColour( wxColour( 0, 128, 0 ) );
	
	fgSizer7->Add( m_staticTextOtherErrorsDISPLAY, 0, wxALL, 5 );
	...
	m_staticTextOtherErrorsCR = new wxStaticText( m_panelCR, wxID_ANY, wxT("YES"), wxDefaultPosition, wxSize( 230,20 ), 0|wxSIMPLE_BORDER );
	m_staticTextOtherErrorsCR->Wrap( -1 );
	m_staticTextOtherErrorsCR->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	m_staticTextOtherErrorsCR->SetForegroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOW ) );
	m_staticTextOtherErrorsCR->SetBackgroundColour( wxColour( 0, 128, 0 ) );
	
	fgSizer71->Add( m_staticTextOtherErrorsCR, 0, wxALL, 5 );
	...
	m_staticTextOtherErrorsKP = new wxStaticText( m_panelKP, wxID_ANY, wxT("YES"), wxDefaultPosition, wxSize( 230,20 ), 0|wxSIMPLE_BORDER );
	m_staticTextOtherErrorsKP->Wrap( -1 );
	m_staticTextOtherErrorsKP->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	m_staticTextOtherErrorsKP->SetForegroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOW ) );
	m_staticTextOtherErrorsKP->SetBackgroundColour( wxColour( 0, 128, 0 ) );
	
	fgSizer711->Add( m_staticTextOtherErrorsKP, 0, wxALL|wxEXPAND, 5 );
