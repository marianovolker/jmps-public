...
inline bool GGlobalSystemInformation::isEmbeddedSPC()
{
	return m_blEmbeddedSPC;
}

inline bool GGlobalSystemInformation::isSPCEmbeddedIntoM3()
{
	return ( m_blEmbeddedSPC && m_eSPOTModel == eM3 );
}
