...
void GContactlessReaderMenu::ShowResultsScreen(char* pcResult)
{
	...
	else
	{
		...
		arypcLabels[2] = "";
		arypcLabels[3] = "";
		arypcLabels[4] = "  Present contactless card in front of reader.";
		arypcLabels[5] = "";
		arypcLabels[6] = "";
	}
...
int GContactlessReaderMenu::GetTagStrings(GSoftKeysWindowTemplate::tStringTagMap & rMap)
{
	...
	else //there is an OTI reader connected
	{
		...
		rMap[GSoftKeysWindowTemplate::eSEGMENT_6] = std::string("  Present contactless card in front of reader.");
