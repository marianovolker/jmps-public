...
public class AbMensualesTarifasEliminarActivity extends Activity
{
   @Override
   protected void onCreate(Bundle savedInstanceState)
   {
      super.onCreate(savedInstanceState);
      setContentView(R.layout.activity_ab_mensuales_tarifas_eliminar);
   ...
   public static class PlaceholderFragment extends ListFragment
   {
      ...
      public void onViewCreated(View view, Bundle savedInstanceState)
      {
         ...
         if (array != null)
         {
            tarifasMes = Arrays.asList(array);
      ...
      public void onListItemClick(ListView l, View v, int position, long id)
      {
         ...
         builder.setMessage("�Est� seguro que quiere eliminar la tarifa " + tarifasMes.get(position).getDescripcion() + "?");
         ...
         public void onClick(DialogInterface dialog, int which)
         {
            switch(which)
            {
               case DialogInterface.BUTTON_POSITIVE :
                  ...
                  helper.delete(tarifasMes.get(position));
                  helper.close();
                  Toast.makeText(PlaceholderFragment.this.getActivity(), R.string.toastAbMensualesTarifaEliminacion, Toast.LENGTH_SHORT).show();
