...
package com.gilbarco.globaltools.spotlogcollector.widgets;
...
import com.gilbarco.globaltools.spotlogcollector.main.gui.SPOTLogCollectorComponentFormatter;

@SuppressWarnings("serial")
public class JSPOTLogCollectorDialog extends JDialog implements WindowListener
{
	// ******************************************************************
	// INNER TYPES
	// ******************************************************************
	...
	{
		return SPOTLogCollectorComponentFormatter.getDefaultFont( );
	}

	public static Font getDefaultStatusFont()
	{
		return SPOTLogCollectorComponentFormatter.getDefaultStatusFont( );
	}

	public static Color getPanelDefaultBackgroundColor()
	{
		return SPOTLogCollectorComponentFormatter.getPanelDefaultBackgroundColor( );
	}

	public static Component setDefaultFont(Component c)
	{
		return SPOTLogCollectorComponentFormatter.setDefaultFont( c );
	}

	public static Component setDefaultStatusFont(Component c)
	{
		return SPOTLogCollectorComponentFormatter.setDefaultStatusFont( c );
	}

	public static Container setPanelDefaultBackgroundColor(Container c)
	{
		return SPOTLogCollectorComponentFormatter.setPanelDefaultBackgroundColor( c );
	}
	...
	// CONSTRUCTORS.
	// ******************************************************************
	public JSPOTLogCollectorDialog()
	{
		commonConstructor( );
	}
	 ...
	 * @param owner
	 */
	public JSPOTLogCollectorDialog(Frame owner)
	{
		super( owner );
		commonConstructor( );
	}
	 ...
	 * @param owner
	 */
	public JSPOTLogCollectorDialog(Dialog owner)
	{
		super( owner );
		commonConstructor( );
	}
	 ...
	 * @param owner
	 */
	public JSPOTLogCollectorDialog(Window owner)
	{
		super( owner );
		commonConstructor( );
	}
	 ...
	 * @param modal
	 */
	public JSPOTLogCollectorDialog(Frame owner, boolean modal)
	{
		super( owner, modal );
		commonConstructor( );
	}
	 ...
	 * @param title
	 */
	public JSPOTLogCollectorDialog(Frame owner, String title)
	{
		super( owner, title );
		commonConstructor( );
	}
	 ...
	 * @param modal
	 */
	public JSPOTLogCollectorDialog(Dialog owner, boolean modal)
	{
		super( owner, modal );
		commonConstructor( );
	}
	 ...
	 * @param title
	 */
	public JSPOTLogCollectorDialog(Dialog owner, String title)
	{
		super( owner, title );
		commonConstructor( );
	}
	 ...
	 * @param modalityType
	 */
	public JSPOTLogCollectorDialog(Window owner, ModalityType modalityType)
	{
	 ...
	 * @param title
	 */
	public JSPOTLogCollectorDialog(Window owner, String title)
	{
		super( owner, title );
		commonConstructor( );
	}
	 ...
	 * @param modal
	 */
	public JSPOTLogCollectorDialog(Frame owner, String title, boolean modal)
	{
	 ...
	 * @param modal
	 */
	public JSPOTLogCollectorDialog(Dialog owner, String title, boolean modal)
	{
		super( owner, title, modal );
		commonConstructor( );
	}
	 ...
	 * @param modalityType
	 */
	public JSPOTLogCollectorDialog(Window owner, String title, ModalityType modalityType)
	{
	 ...
	 * @param gc
	 */
	public JSPOTLogCollectorDialog(Frame owner, String title, boolean modal, GraphicsConfiguration gc)
	{
	 ...
	 * @param gc
	 */
	public JSPOTLogCollectorDialog(Dialog owner, String title, boolean modal, GraphicsConfiguration gc)
	{
		super( owner, title, modal, gc );
		commonConstructor( );
	}
	...
	/**
	 * This is the method invoked from ALL the other JSPOTLogCollectorDialog(...) constructors. Then this delegated "constructor" is in charge to construct the main panel (the area between caption and
	...
	private void commonConstructor()
	{
		...
		blSavingData = false;
		createMainPanel( );
		SPOTLogCollectorComponentFormatter.setPanelDefaultBackgroundColor( super.getContentPane( ) );
		SPOTLogCollectorComponentFormatter.setDefaultFont( super.getContentPane( ) );
	 ...
	 * 
	 * @return JPanel : The main panel object of this JSPOTLogCollectorDialog.
	...
	{
		if (blBkColor)
						SPOTLogCollectorComponentFormatter.setPanelDefaultBackgroundColor( pnlMain );

		if (blMainFont)
						SPOTLogCollectorComponentFormatter.setDefaultFont( pnlMain );

		if (blStatusFont && pnlStatus != null)
												SPOTLogCollectorComponentFormatter.setDefaultStatusFont( pnlStatus );
	...
	{
		return SPOTLogCollectorComponentFormatter.getDefaultTitlePanelFont( );
	}

	public static Font getDefaultSmallFont()
	{
		return SPOTLogCollectorComponentFormatter.getDefaultSmallFont( );
	}

	public static Font getDefaultLargeFont()
	{
		return SPOTLogCollectorComponentFormatter.getDefaultLargeFont( );
	}

	public static Font getDefaultButtonFont()
	{
		return SPOTLogCollectorComponentFormatter.getDefaultButtonFont( );
	}
