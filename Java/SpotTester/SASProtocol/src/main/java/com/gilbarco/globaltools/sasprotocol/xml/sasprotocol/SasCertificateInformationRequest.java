 ...
 */
public class SasCertificateInformationRequest extends SasXmlRequestMsg
{
	// ******************************************************************
	// PRIVATE FIELDS.
	// ******************************************************************
	...
	// PUBLIC METHODS.
	// ******************************************************************
	public SasCertificateInformationRequest()
	{
		this.sasRequestType = SasRequestType.CERTIFICATE_INFORMATION_REQUEST;
	}
